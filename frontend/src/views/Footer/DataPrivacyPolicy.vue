  ...
  >
    ...
    <div class="d-block text-center">
      ...
      <p>
        ...
        Die Erfassung dieser Daten erfolgt automatisch, sobald Sie unsere Website
        betreten.
      </p>
      <p><strong>Wofür nutzen wir Ihre Daten?</strong></p>
      <p>
        Daten werden erhoben, um eine fehlerfreie Bereitstellung der
      ...
      <p>
        ...
        dieser Daten zu verlangen. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz
        können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden.
        Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.
      </p>
      <p>
        Außerdem haben Sie das Recht, unter bestimmten Umstönden die Einschränkung
        der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Details hierzu
        entnehmen Sie der Datenschutzerklörung unter &bdquo;Recht auf Einschrönkung
      ...
      <p>
        ...
        gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklörung.
      </p>
      <p>
      ...
      <h5>Widerspruchsrecht gegen die Datenerhebung in besonderen Föllen sowie gegen Direktwerbung (Art. 21 DSGVO)</h5>
      <p>
        <strong>
          ...
          beruht, entnehmen Sie dieser Datenschutzerklörung. Wenn Sie Widerspruch
      ...
      <p>
        <strong>
          Es wird keine Form von Werbung betrieben.
        </strong>
      </p>
      ...
      <p>
        ...
        einen Dritten in einem göngigen, maschinenlesbaren Format aushöndigen zu
      ...
      <p>
        ...
        Daten, deren Herkunft und Empfönger und den Zweck der Datenverarbeitung und
      ...
      <h5>Recht auf Einschrönkung der Verarbeitung</h5>
      <p>
        Sie haben das Recht, die Einschrönkung der Verarbeitung Ihrer personenbezogenen
        Daten zu verlangen. Hierzu können Sie sich jederzeit unter der im Impressum
        angegebenen Adresse an uns wenden. Das Recht auf Einschrönkung der Verarbeitung
        besteht in folgenden Föllen:
      </p>
      <ul>
        <li>
          Wenn Sie die Richtigkeit Ihrer bei uns gespeicherten personenbezogenen
          Daten bestreiten, benötigen wir in der Regel Zeit, um dies zu überprüfen.
          Für die Dauer der Prüfung haben Sie das Recht, die Einschrönkung der Verarbeitung
          Ihrer personenbezogenen Daten zu verlangen.
        </li>
        <li>
          Wenn die Verarbeitung Ihrer personenbezogenen Daten unrechtmößig geschah/geschieht,
          können Sie statt der Löschung die Einschrönkung der Datenverarbeitung verlangen.
        </li>
        <li>
          Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen, Sie sie
          jedoch zur Ausübung, Verteidigung oder Geltendmachung von Rechtsansprüchen
          benötigen, haben Sie das Recht, statt der Löschung die Einschrönkung der
          Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
        </li>
        <li>
          Wenn Sie einen Widerspruch nach Art. 21 Abs. 1 DSGVO eingelegt haben,
          muss eine Abwögung zwischen Ihren und unseren Interessen vorgenommen werden.
          Solange noch nicht feststeht, wessen Interessen überwiegen, haben Sie das
          Recht, die Einschrönkung der Verarbeitung Ihrer personenbezogenen Daten
          zu verlangen.
        </li>
      </ul>
      <p>
        Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschrönkt haben,
        dürfen diese Daten &ndash; von ihrer Speicherung abgesehen &ndash; nur mit
        ...
        der Europöischen Union oder eines Mitgliedstaats verarbeitet werden.
      </p>
      ...
      <p>
        Die von uns verwendeten Cookies sind so genannte &bdquo;Session-Cookies&ldquo;.
        Diese Cookies bleiben auf Ihrem Endgerät gespeichert bis Sie diese löschen.
        Diese Cookies ermöglichen es uns, Ihren Browser beim nöchsten Besuch wiederzuerkennen.
      </p>
      <p>
        Sie können Ihren Browser so einstellen, dass Sie über das Setzen von Cookies
        informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von
        Cookies für bestimmte Fölle oder generell ausschließen sowie das automatische
        Löschen der Cookies beim Schließen des Browsers aktivieren. Bei der Deaktivierung
        von Cookies kann die Funktionalitöt dieser Website eingeschränkt sein.
      </p>
      <p>
        ...
        (z.&nbsp;B. Warenkorbfunktion) erforderlich sind, werden auf Grundlage
      ...
      <p>
        ...
        Darstellung und der Optimierung seiner Website &ndash; hierzu müssen die
